...
<!--    <link rel="stylesheet" type="text/css" href="main/main.css">-->
    ...
    <title>Greater Height Foundation</title>
      ...
      <aside class="main-sidebar hidden-print">
        <div style="position: relative; overflow: hidden; width: auto; height: 588px;" class="slimScrollDiv"><section style="overflow: hidden; width: auto; height: 588px;" class="sidebar">
          <div class="user-panel">
            <div class="pull-left image"><img src="../img/logo.png"></div>
...
<!--            <li><a href="#"><i class="fa fa-user"></i><span>Profile</span></a></li>-->
            <li class="treeview"><a href="view_applicants.php"><i class="fa fa-user"></i><span>View Applicants</span></a></li>
            <li class="treeview"><a href="manage_applicant.php"><i class="fa fa-object-ungroup"></i><span>Manage Applicants</span></a>
            </li>
            <li><a href="award_scholarship.php"><i class="fa fa-pie-chart"></i><span>Award Scholarship</span></a></li>
            <li><a href="add_pin.php"><i class="fa fa-eye"></i><span>Add Pin</span></a></li>
            <li><a href="send_mail.php"><i class="fa fa-envelope"></i><span>Send Mail</span></a></li>
            <li><a href="print_slip.php"><i class="fa fa-print"></i><span>Print Slip</span></a></li>
            <li class="treeview"><a href="reset_password.php"><i class="fa fa-expeditedssl"></i><span>Reset Password</span></a>
            <li class="treeview"><a href="add_admin.php"><i class="fa fa-user-plus"></i><span>Add Admin</span></a>
            </li>
