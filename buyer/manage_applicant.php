...
<div class="page-title">
  <div>
    <h1><i class="fa fa-object-ungroup"></i> Update Applicant Detail</h1>
  </div>
  <div>
...
<div class="card">
       <div class="panel panel-primary">
        <div class="panel-heading">
            <h4 class="text-center">Update Applicant Detail</h4>
        </div>
        <div class="panel-body">
            <form method="POST" action="">                
                ...
                <br>
                <center><input name="fetch_detail_btn" id="submit" value="Fetch Details" class="btn btn-large btn-primary text-center" type="submit"></center>  
            </form>
           </div>
    </div>
</div>      </div>
