...
<div class="pace-activity"></div></div>
    <div class="wrapper">
      <!-- Navbar-->
      <header class="main-header hidden-print"><a class="logo" href=""><h5><strong>Back to Home</strong></h5></a>
            ...
            <ul class="top-nav">
              ...
              <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user fa-lg"></i></a>
                <ul class="dropdown-menu settings-menu">
                  ...
                  <li><a href="../buyer.php"><i class="fa fa-sign-out fa-lg"></i> Logout</a></li>
                </ul>
              </li>
            </ul>
          </div>
      ...
      <aside class="main-sidebar hidden-print">
        <div style="position: relative; overflow: hidden; width: auto; height: 588px;" class="slimScrollDiv"><section style="overflow: hidden; width: auto; height: 588px;" class="sidebar">
          <div class="user-panel">
            <div class="pull-left image">v</div>
            <div class="pull-left info">
              <p></p>
              <p class="designation text-center"><b>Ebuka</b></p>
              <br>
            </div>
          </div>
          <!-- Sidebar Menu-->
...
<!--            <li class="active"><a href="user_dashboard.php"><i class="fa fa-dashboard"></i><span>Dashboard</span></a></li>-->
            ...
            <li class="treeview"><a href="#"><i class="fa fa-laptop"></i><span>Pending Reveiw</span></a>
            </li>
